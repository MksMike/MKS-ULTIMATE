...
| 2026-05-25 | [`CHECKPOINT-2026-05-25-audit.md`](CHECKPOINT-2026-05-25-audit.md) | Auditoria completa de 10 pilares + Lote A (sync documental) + Lote B2/B3 (notas ADR-020/013); B1 suspenso após dono apontar padrão de 3 erros analíticos consecutivos. Próximo passo fixado: validação empírica E2E. **Versão detalhada (arquivo por arquivo) resgatada em 2026-07-19:** [`AUDITORIA-2026-05-25.md`](AUDITORIA-2026-05-25.md) — histórica, achados já tratados. |
